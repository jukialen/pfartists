export const en = {
  ...
  NavForm: {
    ...
    theSameEmail: "Account with this e-mail already exist.",
    setErrorMessageLogin: "Your e-mail or password is incorrect.",
    ...
    titleOfRegistration: "Registration for free!",
    titleOfLogin: "Login!",
    email: "E-mail",
    password: "Password",
    login: "Login",
    ...
    successInfoRegistration: "Congratulation! You are registered. Check your mailbox and confirm your e-mail in order to you'll can log in.",
